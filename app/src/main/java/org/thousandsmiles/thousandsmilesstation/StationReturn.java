...
public class StationReturn extends AsyncTask<Object, Object, Object> {
    ...
    private void returnFromAway()
    {
        ...
        lock = clinicStationREST.returnStationFromAwayState(clinicStationId);
