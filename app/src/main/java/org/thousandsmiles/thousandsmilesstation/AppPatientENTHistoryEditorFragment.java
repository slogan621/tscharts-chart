...
public class AppPatientENTHistoryEditorFragment extends Fragment {
    ...
    public static AppPatientENTHistoryEditorFragment newInstance() {
        return new AppPatientENTHistoryEditorFragment();
    }
