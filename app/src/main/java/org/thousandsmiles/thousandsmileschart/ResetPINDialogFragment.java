...
public class ResetPINDialogFragment extends DialogFragment {
    ...
    */
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        m_view = inflater.inflate(R.layout.reset_pin_dialog, null);

        builder.setView(m_view)
                    // Add action buttons
                    .setPositiveButton(R.string.action_reset_pin, new DialogInterface.OnClickListener() {
                        @Override
        ...
        ret = builder.create();
        ret.setTitle(R.string.action_reset_pin);
